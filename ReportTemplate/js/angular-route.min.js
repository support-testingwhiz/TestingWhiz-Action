      ...
      function (a, c, b, f, h, k, r) {
        function l(b) {
          ...
          ;(w =
            ...
            e &&
            p.$$route === e.$$route &&
            d.equals(p.pathParams, e.pathParams) &&
            !p.reloadOnSearch &&
            !x) ||
            (!e && !p) ||
            (a.$broadcast('$routeChangeStart', p, e).defaultPrevented &&
              b &&
              b.preventDefault())
        }
        function m() {
            ...
            (x = !1),
              (t.current = e) &&
                ...
                (d.isString(e.redirectTo)
                  ? c.path(u(e.redirectTo, e.params)).search(e.params).replace()
                  : c
              ...
              f
                  ...
                  if (e) {
                    ...
                    d.isDefined((b = e.template))
                      ...
                      : d.isDefined((c = e.templateUrl)) &&
                        ...
                        d.isDefined(c) &&
                          ((e.loadedTemplateUrl = r.valueOf(c)), (b = k(c))))
                ...
                .then(
                  ...
                  function (b) {
                    e == t.current && a.$broadcast('$routeChangeError', e, v, b)
                  }
                )
        }
        function n() {
            ...
            updateParams: function (a) {
              if (this.current && this.current.$$route)
                (a = d.extend({}, this.current.params, a)),
                  c.path(u(this.current.$$route.originalPath, a)),
                  c.search(a)
              else throw B('norout')
            }
          }
